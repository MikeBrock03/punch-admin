                ...
                if(time != null){
                  ...
                  modelList.forEach((element) {
                    if(element.clockIn != null){
                      double elTime =  element.clockIn.hour + element.clockIn.minute/60.0;
                      if(tm < elTime){
                        inSt = true;
                      }
                    }
                  ...
                  modelList.forEach((element) {
                    if(element.clockOut != null){
                      double elTime =  element.clockOut.hour + element.clockOut.minute/60.0;
                      if(tm < elTime){
                        outSt = true;
                      }
                    }
                  ...
                  if(inSt == false && outSt == false){
                    ...
                    Message.show(_globalScaffoldKey, 'Selected time shouldn\'t before other times in the same day');
                    setState(() {
                      if(type == 1){
